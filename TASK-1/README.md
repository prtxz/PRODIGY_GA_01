...
The model was trained using causal language modeling (next-token prediction). For each sequence, the model learns to predict the next token based on previous context.
...
this is giving me an unfair advantage
